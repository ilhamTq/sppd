            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable dataKey="id" header={header1}>
                        ...
                        <Column field="alamat" header="Alamat" style={{ minWidth: '150px' }} sortable />
                        <Column field="telp" header="No. Telp" style={{ minWidth: '150px' }} sortable />
                        <Column field="jabatan" header="Jabatan" style={{ minWidth: '150px' }} sortable />
                        <Column field="golongan" header="Pangkat/Gol" style={{ minWidth: '150px' }} sortable />
